<div align="center">
  ...
  <p>
    ...
    <img alt="coverage: 95.4%" src="https://img.shields.io/badge/coverage-95.4%25-4ade80" />
...
6. 🏷 **Typed search.**
   ...
   csift stepped in every one of these traps already, so `csift search -t user.answer` (one of 26 `{role}.{class}.{sub}` labels) finds exactly what a naive grep swears was never said.
