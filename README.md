<div align="center">
  ...
  <p>
    ...
    <img alt="coverage: 96.6%" src="https://img.shields.io/badge/coverage-96.6%25-4ade80" />
    <img alt="mutation score: 92.5%" src="https://img.shields.io/badge/mutation%20score-92.5%25-a3e635" />
...
|---|---:|---:|---|
| end-to-end | 562 | 83.0% | the writer, its gate and its trigger read in the shipped binary, and a specimen observed on disk or live |
| &nbsp;&nbsp;of which chain traced | 562 | 83.0% | the three hops quoted at byte offsets in `producer_chain`; the anchors line below is the measured state of those offsets |
...
| specimen-only | 14 | 2.1% | observed on disk or live; the writer not traced (or traced only in part) (8 of them with a partly traced writer) |
| producer-only | 74 | 10.9% | the writer traced in full; no specimen exists in the corpus or could be produced here |
...
| total | 677 | 100.0% | one claim per Claude Code behavior csift depends on, verified at Claude Code 2.1.258 |

A traced claim pins each hop at a byte offset in that build, and the gate re-reads every one of them:

`anchors byte-exact at Claude Code 2.1.258: 6,783 of 7,390 (elided 342, absent 183, prefix-only 82)`
