...
|---|---:|---:|---|
| end-to-end | 517 | 79.1% | the writer, its gate and its trigger read in the shipped binary, and a specimen observed on disk or live |
| &nbsp;&nbsp;of which chain traced | 517 | 79.1% | the three hops quoted at byte offsets in `producer_chain`; the anchors line below is the measured state of those offsets |
...
| producer-only | 33 | 5.0% | the writer traced in full; no specimen exists in the corpus or could be produced here |
...
`anchors byte-exact at Claude Code 2.1.258: 6,138 of 6,751 (elided 343, absent 186, prefix-only 84)`
