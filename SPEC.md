...
| `--kind builtin-task\|workflow\|teammate` | repeatable enum | all | filter to a subagent kind (`teammate` = `in_process_teammate`/FleetView agents) |
